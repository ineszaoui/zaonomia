...
class Laboratoire2 extends Controller
{
    ...
    public function index(){
	 ...
	 public function validReponse(){
	 	...
	 	if ($nom == $labonnereponse ){
 			...
 			$data['message']='Mauvaise réponse! Veuillez recommencer. ';
	 		$data['bouton']='Retour à l\'indice';
	 	}
	 	echo view('ReponseLabo2_view', $data);
